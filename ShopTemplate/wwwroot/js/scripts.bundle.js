...
var KTImageInput = function (e, t) {
    ...
    if (null != e) {
        var i = {},
            ...
            l = function (e) {
                e.preventDefault(), !1 !== KTEventHandler.trigger(n.element, "kt.imageinput.cancel", n) && (WebFileCancel(n), n.inputElement.value = "", null !== n.hiddenElement && (n.hiddenElement.value = "0"), KTEventHandler.trigger(n.element, "kt.imageinput.canceled", n))
            },
            s = function (e) {
                delete n.wrapperElement.dataset.img, $(n.wrapperElement).data('img', null),
                    e.preventDefault(), !1 !== KTEventHandler.trigger(n.element, "kt.imageinput.remove", n) && (WebFileCancel(n), n.inputElement.value = "", null !== n.hiddenElement && (n.hiddenElement.value = "1"), KTEventHandler.trigger(n.element, "kt.imageinput.removed", n))
            };
